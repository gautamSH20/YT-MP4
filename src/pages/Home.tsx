...
export const Home = () => {
  ...
  return (
    <div className="flex flex-col items-center md:h-[70%] p-4 md:w-[60vh] h-[70%] w-[45vh] rounded-md shadow-lg dark:bg-[#1e2939] dark:shadow-[#1e2949] shadow-gray-400 bg-white">
